...
test runner (use Run with action=verifiers) or a code review of an arbitrary target (use review) \
— it is a self-check of whether what you just did is actually correct and complete."
    }
