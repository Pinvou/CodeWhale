...
impl ModelContextFragment {
    ...
    pub fn with_max_bytes(
        ...
        // Explicit host instructions retain the 100 KiB product contract;
        // every other volatile fragment stays under the 10K-token ceiling.
        ...
        // Token-ceiling safety net (4 bytes ≈ 1 token), with the same narrow
        // permissions exception rather than a global cap increase.
